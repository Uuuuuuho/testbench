...
# 1 "C:\\Users\\kim\\eclipse-workspace\\src\\Projects\\AurixRacer_SB_TC27D//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.c"
...
boolean AppShell_enc(pchar args, void *data, IfxStdIf_DPipe *io)
{
 if (Ifx_Shell_matchToken(&args, "?") != 0)
    ...
    {
     IfxStdIf_DPipe_print(io, "  Encoder speed: %f, position: %f, direction: %1d, turn: %d ""\r\n",
       IR_Encoder.speed, IR_Encoder.rawPosition, IR_Encoder.direction, IR_Encoder.turn);
    }
...
void AsclinShellInterface_runEncScan(void){
 IfxStdIf_DPipe_print(&g_AsclinShellInterface.stdIf.asc, "position: %5f, turn: %5d, speed: %5f" "\r\n", IR_Encoder.rawPosition, IR_Encoder.turn, IR_Encoder.speed);
}
