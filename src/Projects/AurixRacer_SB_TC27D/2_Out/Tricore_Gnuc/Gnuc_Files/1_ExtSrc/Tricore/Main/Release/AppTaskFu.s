...
.LVL24:
	...
	.loc 1 131 0
	mov	%d15, 0
	st.w	[%a12] lo:testVol, %d15
.L21:
	.loc 1 133 0
	movh.a	%a13, hi:testSrv
	ld.w	%d4, [%a13] lo:testSrv
	.loc 1 134 0
	movh	%d15, 16128
	.loc 1 133 0
	call	__extendsfdf2
...
.LFE730:
	...
	.global	testSrv
.section .data.testSrv,"aw",@progbits
	.align 2
	.type	testSrv, @object
	.size	testSrv, 4
testSrv:
