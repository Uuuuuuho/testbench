...
void appTaskfu_10ms(void)
{
 task_cnt_10m++;
    ...
    clearBuffer();
    clearBuffer_RIGHT();
# 257 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/Main/Release/AppTaskFu.c"
...
{
 task_cnt_100m++;
# 296 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/Main/Release/AppTaskFu.c"
