...
.LVL4:
	movh.a	%a4, hi:.LC0
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.19370
	mov	%d4, %d2
	mov	%d5, 2
	lea	%a4, [%a4] lo:.LC0
	lea	%a5, [%a5] lo:.LC1
	mov	%d6, 138
	lea	%a6, [%a6] lo:__func__.19370
...
.section .text.BasicGpt12Enc_IR_Encoder_turn,"ax",@progbits
	.align 1
	.global	BasicGpt12Enc_IR_Encoder_turn
	.type	BasicGpt12Enc_IR_Encoder_turn, @function
...
.LFB422:
	...
	movh.a	%a4, hi:g_Gpt12Enc
	lea	%a4, [%a4] lo:g_Gpt12Enc
	j	IfxGpt12_IncrEnc_updateFromT2_buff
.LVL7:
.LFE422:
	.size	BasicGpt12Enc_IR_Encoder_turn, .-BasicGpt12Enc_IR_Encoder_turn
.section .text.BasicGpt12Enc_IR_Encoder_reset,"ax",@progbits
	.align 1
	.global	BasicGpt12Enc_IR_Encoder_reset
	.type	BasicGpt12Enc_IR_Encoder_reset, @function
...
.LFB423:
	...
	movh.a	%a4, hi:g_Gpt12Enc
	lea	%a4, [%a4] lo:g_Gpt12Enc
	j	IfxGpt12_IncrEnc_resetTurn
.LVL8:
.LFE423:
	.size	BasicGpt12Enc_IR_Encoder_reset, .-BasicGpt12Enc_IR_Encoder_reset
.section .text.Speed_Avg,"ax",@progbits
	.align 1
	.global	Speed_Avg
	.type	Speed_Avg, @function
Speed_Avg:
.LFB424:
	.loc 1 154 0
	.loc 1 155 0
	movh.a	%a15, hi:IR_Encoder
	lea	%a2, [%a15] lo:IR_Encoder
	ld.w	%d2, [%a2] 16
	movh	%d15, 16672
	div.f	%d15, %d2, %d15
	st.w	[%a15] lo:IR_Encoder, %d15
	ret
.LFE424:
	.size	Speed_Avg, .-Speed_Avg
...
.LVL10:
	movh.a	%a13, hi:IR_Encoder
	.loc 1 163 0
	mov.aa	%a4, %a15
	.loc 1 162 0
	st.w	[%a13] lo:IR_Encoder, %d2
	.loc 1 163 0
	call	IfxGpt12_IncrEnc_getRawPosition
.LVL11:
	itof	%d2, %d2
	.loc 1 162 0
	lea	%a12, [%a13] lo:IR_Encoder
	.loc 1 164 0
	mov.aa	%a4, %a15
	.loc 1 163 0
	st.w	[%a12] 4, %d2
...
.LVL12:
	...
	st.b	[%a12] 8, %d2
	.loc 1 165 0
	call	IfxGpt12_IncrEnc_getTurn
.LVL13:
.LBB18:
.LBB19:
	.loc 1 173 0
	ld.w	%d4, [%a13] lo:IR_Encoder
.LBE19:
.LBE18:
	.loc 1 165 0
	st.w	[%a12] 12, %d2
...
.section .text.SpeedCalculation,"ax",@progbits
	.align 1
	.global	SpeedCalculation
	.type	SpeedCalculation, @function
SpeedCalculation:
.LFB426:
	.loc 1 172 0
	.loc 1 173 0
...
.LASF15:
	.string	"updatePeriod"
	.extern	IfxGpt12_IncrEnc_getTurn,STT_FUNC,0
	...
	.extern	IfxGpt12_IncrEnc_resetTurn,STT_FUNC,0
	.extern	IfxGpt12_IncrEnc_updateFromT2_buff,STT_FUNC,0
